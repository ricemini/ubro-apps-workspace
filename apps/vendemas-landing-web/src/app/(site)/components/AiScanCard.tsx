      ...
      <div className="rotate-2">
        <div className="rounded-[1.5rem] p-[1px] bg-gradient-to-br from-primary-500 to-secondary-500 shadow-2xl">
          <div className="rounded-[1.45rem] bg-white/90 backdrop-blur-lg p-5 sm:p-6 relative overflow-hidden">
            {/* scan line */}
            {!reduce && (
              <div aria-hidden className="absolute inset-x-0 top-0 h-12 bg-gradient-to-b from-primary-200/40 to-transparent animate-scan" />
            )}
            ...
            <h3 className="text-lg font-bold text-secondary mb-3">Catálogo detectado</h3>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={name} className="flex items-center justify-between rounded-lg bg-secondary/5 px-3 py-2">
            ...
            <button type="button" className="mt-4 w-full rounded-lg bg-primary-500 text-primary-on px-4 py-3 hover:brightness-[1.05] transition">
              Importar productos
            </button>
          </div>
        </div>
