...
export const metadata: Metadata = {
  ...
  description: 'Cobros CoDi, catálogo desde una foto, inventario, promociones y estadísticas con IA, facturación y más.',
  openGraph: {
    title: 'Todas las funciones — VendeMás',
    description: 'Cobros CoDi, catálogo desde una foto, inventario, promociones y estadísticas con IA, facturación y más.',
  },
...
const faqs = [
  {
    ...
    answer: 'El plan gratuito incluye funciones básicas. Las funciones con IA y avanzadas requieren suscripción.'
  },
  {
    question: '¿Qué tan precisa es la IA para escanear menús?',
    answer: 'Nuestra IA tiene 95% de precisión. Siempre puedes revisar y editar antes de confirmar.'
  },
  {
    question: '¿Puedo usar VendeMás sin internet?',
    answer: 'Sí, todas las funciones principales funcionan offline y se sincronizan cuando hay conexión.'
  },
  {
    question: '¿Hay límite en el número de productos?',
    answer: 'El plan gratuito permite hasta 100 productos. Los planes pagos no tienen límite.'
  }
];
                ...
                <ul className="space-y-3">
                  {feature.bullets.map((bullet, bulletIndex) => (
                    <li key={bulletIndex} className="flex items-start space-x-3">
                      ...
                      <span className="text-body text-secondary-500/90">{bullet}</span>
                    </li>
                  ))}
                </ul>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {faqs.map((faq, index) => (
              <div key={index} className="space-y-3">
                ...
                <p className="text-body text-secondary-500/80">
                  {faq.answer}
                </p>
              </div>
            ))}
