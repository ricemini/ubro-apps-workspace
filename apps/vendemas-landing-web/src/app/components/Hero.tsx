              ...
              <div className="bg-white rounded-2xl p-6 shadow-inner">
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="text-display font-semibold text-lg mb-2">Catálogo detectado</h3>
    ...
    >
      ...
      >
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <h2 className="text-display text-2xl text-secondary-500">Demo de IA</h2>
          <button 
            onClick={onClose} 
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-secondary-500/70">
                  Ve cómo la IA de VendeMás transforma una foto de tu menú en un catálogo completo
                </p>
              </div>
            </div>
          </div>
